...
"""
  ...
  Scenario: Inferrence with existing address as a source removes saons
    Given the following addresses exist:
    | saon      | paon | street      | town     | postcode |
    | old house | 7    | HIGH STREET | TESTTOWN | SW1A 1AA |
    | new house | 1    | HIGH STREET | TESTTOWN | SW1A 1AA |
    And I send a request to infer from the address "1, HIGH STREET, TESTTOWN, SW1A 1AA"
    Then the JSON response should contain:
"""
[
